...
-- NORMAL USERS (COULD BE FUNCTION USED THERE TO CREATE USERS...)
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user1@gmail.com', 'user1', '$2a$10$oKb/VYe4RVcT4Mwxqj97w.xiVuEI1ndrX9DOiwUh52qm1lsCTg/xi', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user2@gmail.com', 'user2', '$2a$10$59iKwiUWyfkTXrOYR1OWReTDfa0I1bnXy/CkwuX4OrrM5rK0IxppO', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user3@gmail.com', 'user3', '$2a$10$4o528TbjB2W6YcFe.HjxgeCiLElk0PVpJJKlHyZc1ty3PQS.xsw.W', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user4@gmail.com', 'user4', '$2a$10$Jn/Au5XhkXCzulaeerNPJOrmVGnEJ55hvOajUwSZxVVC9/Od4DFwm', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user5@gmail.com', 'user5', '$2a$10$k1u3KB8CLMBxq4V98YU3IOLEu91oiGmcGY5rCpLINlc44BaMCKcbC', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user6@gmail.com', 'user6', '$2a$10$R4YXp1191OJLqmcTcpvo9.i8bh2Y5fePrvPReBfLz6mE08YG49gbu', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user7@gmail.com', 'user7', '$2a$10$Iu72/t2hh9rZbMZOiyBP1elUcTvGvD81nu9P6yZEvoKLinRqs5j4i', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user8@gmail.com', 'user8', '$2a$10$xmofrS2.2mq0ia0xY4aqquMYV52tBOfwYnpfNqcrRKv6sz9Sy/H0u', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user9@gmail.com', 'user9', '$2a$10$ldGfje08t71c7BMPAEfsJ.UfsDT9TdKcN0.svAT8XpQwuaxbAAB.C', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
INSERT INTO USERS (ACTIVATED, EMAIL, NAME, PASSWORD, REGISTERED, BAN_ID, PROFILEPIC_ID) VALUES (TRUE, 'user10@gmail.com', 'user10', '$2a$10$pftTyJgwlgCyAUf6J9cVhOJwutbn3gdCNVQntInPZOIL4ByT3s27W', NOW() - ROUND(RANDOM() * 365) * '1 day'::interval + ROUND(RANDOM() * 86400) * '1 second'::interval, null, null);
...
-- TOPICS WITH POSTS (EACH TOPIC MUST HAVE AT LEAST ONE POST)
DO'
DECLARE
...
BEGIN
    ...
    (SELECT ID FROM CATEGORIES ORDER BY RANDOM() LIMIT 1), (SELECT ID FROM USERS ORDER BY RANDOM() LIMIT 1));
        WHILE COUNTER_FOR_INNER_POST_LOOP < ROUND(RANDOM() * 250 + 25) LOOP
        IF COUNTER_FOR_INNER_POST_LOOP = 1 THEN RANDOM_DATE_TIME_OF_LAST_POST_UNDER_TOPIC = RANDOM_DATE_TIME_OF_NEXT_TOPIC_IN_LOOP;
        ...
        RANDOM_DATE_TIME_OF_LAST_POST_UNDER_TOPIC, FALSE, COUNTER_FOR_INNER_POST_LOOP, COUNTER_FOR_OUTER_TOPIC_LOOP, (SELECT ID FROM USERS ORDER BY RANDOM() LIMIT 1));
